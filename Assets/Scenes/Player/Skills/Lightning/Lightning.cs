    ...
    private IEnumerator SpawnEnemiesCoroutine()
    {
        for (int i = 0; i < countEnemy; i++)
        {
            if (enemiesToShoot[i] != null)
            {
                ...
                objHealth.healthPoint -= damage * player.Electricity / objHealth.Electricity;
                GameManager.Instance.FindStatName("lightDamage", damage * player.Electricity / objHealth.Electricity);
